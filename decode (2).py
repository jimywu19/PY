...
def main():
    sourcedir = os.path.expandvars('%USERPROFILE%\\Desktop\\coded')
    destdir = os.path.expandvars('%USERPROFILE%\\Desktop\\decoded')
    bakdir = os.path.expandvars('%USERPROFILE%\\Desktop\\bak')
    for dir in [sourcedir,destdir,bakdir]:
